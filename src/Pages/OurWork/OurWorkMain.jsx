  ...
  return (
    <div className="our-work-main">
      ...
      <div className="our-work-center">
        <div className="our-work-main-left">
          ...
          <div className="paragraph-real-estate">
            <p>
              ...
              marketing environment. We offer a truly CUSTOM Video production
              for Real Estate, from music selection to editing style, every
              detail will be created to best showcase your property. On average,
              2 -4 min, dynamic Cinematic Experience is THE most effective way
              to create strong engagement and generate leads. Delivery: NEXT
              DAY.
            </p>
          </div>
        ...
        <div className="our-work-main-right"></div>
      </div>
    </div>
  );
}
